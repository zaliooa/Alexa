...
if (con.LANG === 'TR') {
    ...
    if (con.WORKTYPE === 'private') {
        ...
        Alexa.addCommand({pattern: 'roll', fromMe: true, desc: TRZAR}, (async (message, match) => {
        ...
        Alexa.addCommand({pattern: 'roll', fromMe: false, desc: TRZAR}, (async (message, match) => {
    ...
    if (con.WORKTYPE === 'private') {
        ...
        Alexa.addCommand({pattern: 'roll', fromMe: true, desc: HIZAR}, (async (message, match) => {
        ...
        Alexa.addCommand({pattern: 'roll', fromMe: false, desc: HIZAR}, (async (message, match) => {
    ...
    if (con.WORKTYPE === 'private') {
        ...
        Alexa.addCommand({pattern: 'roll', fromMe: true, desc: ENZAR}, (async (message, match) => {
        ...
        Alexa.addCommand({pattern: 'roll', fromMe: false, desc: ENZAR}, (async (message, match) => {
