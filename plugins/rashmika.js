...
if (Config.WORKTYPE == 'private') {
    ...
    Alexa.addCommand({pattern: 'rashmika', fromMe: true, desc: 'random rashmika images'}, (async (message, match) => {
...
var i = Math.floor(200*Math.random())
    ...
    Alexa.addCommand({pattern: 'rashmika', fromMe: false, desc:'random rashmika images '}, (async (message, match) => {
