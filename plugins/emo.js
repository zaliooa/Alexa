...
if (Config.WORKTYPE == 'private') {
    ...
    Alexa.addCommand({pattern: 'emo ?(.*)', fromMe: true, desc: des}, (async (message, match) => {
    ...
    Alexa.addCommand({pattern: 'emo ?(.*)', fromMe: false, desc: des}, (async (message, match) => {
    ...
    Alexa.addCommand({pattern: 'png ?(.*)', fromMe: true,dontAddCMDList: true}, (async (message, match) => {
