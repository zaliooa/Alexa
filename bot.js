...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp...')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.blueBright.italic('Alexa is working!♥️...')
        );
        ...
        console.log(
            chalk.green.bold('Alexa is working!♥️')
        );
        ...
        if (config.WORKTYPE == 'public') {
            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                ...
                if (conn.user.jid === '@s.whatsapp.net') {
                    ...
                    await conn.sendMessage(conn.user.jid, 'ᴀʟᴇxᴀ ᴡᴀ ʙᴏᴛ ʀᴜɴɴɪɴɢ💫', MessageType.text);
                }
            }
            else {
...
*/
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~_________~ *ᴀʟᴇxᴀ ᴡᴀ ʙᴏᴛ ᴇʀʀᴏʀ!* ~______~*' +
                                    '\n\n*🧞‍♂️ ' + error + '*\n\n```ᴘʟᴇᴀsᴇ ᴛᴇʟ ᴀʙᴜ sᴇʀ ᴜᴘᴅᴀᴛᴇs https://chat.whatsapp.com/DNP9Fd1eWrjKz2DalRI2CX``` ' 
                                    , MessageType.text);
                            }
                        }
                    }
